    ...
    <form method="POST" action = "edit_blog.php?id=<?=$id;?>">
        <div class="data-blog">
            <div class="data-title">
                ...
                <input type="text" name="blog[title]" id="title" value="<?= $blog['b_title']; ?>"><br><br>
            </div>
            <div class="data-content">
                <label for="content">content</label><br><br>
                <textarea name="blog[content]" id="content" cols="30" rows="10"><?= $blog['b_content']; ?></textarea><br><br>
            </div>
            <div class="data-url">
                <label for="url">URL</label><br><br>
                <input type="text" name="blog[url]" id="url" value="<?= $blog['b_url']; ?>"><br><br>
            </div>
            <div class="data-published">
                <label for="published">Published At</label><br><br>
                <input type="date" name="blog[published]" id="published" value="<?= $blog['b_published_at']; ?>"><br><br>
            </div>
