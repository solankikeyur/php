        ...
        <fieldset>
            ...
            <div class="data-account">
                ...
                <div class="data-email">
                    ...
                    <input type="text" name="account[email]" id="email" value="<?php echo getValue('account','email'); ?>" >
                ...
                <div class="data-phonenumber">
                    ...
                    <input type="number" name="account[phonenumber]" id="phonenumber" value="<?php echo getValue('account','phonenumber'); ?>" >
        ...
        <fieldset>
            ...
            <div class="data-address">
                <div class="data-addressline1">
                    ...
                    <input type="text" name="address[addressline1]" id="addressline1" value="<?php echo getValue('address','addressline1'); ?>" >
                    <?php if(validateEmpty('address','addressline1')){echo "<span>Please enter addresslin1</span>";} ?>
                </div><br>
                <div class="data-addressline2">
                    <label for="addressline2">Addressline2</label>
                    <input type="text" name="address[addressline2]" id="addressline2" value="<?php echo getValue('address','addressline2'); ?>" >
        ...
        <fieldset>
            ...
            <div class="data-other">
                <div class="data-describe">
                    ...
                    <textarea id="describe" name="other[describe]" rows="10" cols="25"><?php echo getValue('other','describe'); ?></textarea>
                ...
                <div class="data-business">
                    ...
                    <input type="radio" name="other[business]" id="business" value="<?php echo $b; ?>" <?php if($b == getValue('other','business')){echo "checked";} ?> ><?php echo $b; ?>
                    <?php endforeach; ?>
                </div><br>
                <div class="data-clients">
                    ...
                    <select name="other[clients]">
                        ...
                        <option value="<?php echo $c; ?>" <?php if($c == getValue('other','clients')){echo "selected";} ?>  ><?php echo $c; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div><br>
                ...
                <div class="data-getintouch">
                    ...
                    <input type="checkbox" name="other[getintouch][]" id="getintouch" <?php if(in_array($g,getValue('other','getintouch',[]))){echo "checked";} ?> value="<?php echo $g; ?>" ><?php echo $g; ?>
                    <?php endforeach; ?>
                </div><br>
